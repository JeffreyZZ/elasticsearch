...
public final class AzureStorageSettings {
    ...
    private static Map<String, AzureStorageSettings> getPrimaries(List<AzureStorageSettings> settings) {
        ...
        if (settings.isEmpty()) {
            ...
            primaries.put(storage.getName(), new AzureStorageSettings(storage.getName(), storage.getAccount(), storage.getKey(), storage.getTimeout(), true, storage.getMaxRetries()));
        } else {
